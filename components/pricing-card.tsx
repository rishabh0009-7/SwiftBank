  ...
  return (
    ...
    >
      ...
      <h2 className="flex items-center gap-3 text-xl font-medium capitalize">
        {tier.name}
        {isPopular && (
          <Badge variant="secondary" className="mt-1 z-10 bg-emerald-100 text-emerald-700 hover:bg-emerald-100">
            🔥 Most Popular
          </Badge>
        )}
      </h2>
      ...
      <Button
        ...
        className={cn(
          "w-full",
          !isHighlighted && "bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white"
        )}
      >
        {tier.cta}
