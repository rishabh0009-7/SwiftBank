      ...
      <div className="container mx-auto px-4 lg:px-6 py-20 lg:py-32">
        <div className="flex flex-col text-center gap-8 items-center relative z-10">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-3xl md:text-5xl tracking-tighter max-w-2xl font-bold text-gray-900">
              Ready to Launch Your
              <span className="text-emerald-500 block">Digital Bank?</span>
            </h3>
            <p className="text-lg leading-relaxed tracking-tight text-gray-600 max-w-2xl">
              Join hundreds of fintech companies using SwiftBank to power their digital banking solutions. 
              Start building with our developer-friendly APIs and white-label infrastructure today.
            </p>
          </div>
